    ...
    return (
        <Segment.Group>
            ...
            <Segment>
                <Item.Group>
                    <Item>
                        <Item.Image size='tiny' circular src={host?.image || 'assets/users/user.png'} style={{ marginBottom: 3 }} />        
                    <Item.Content>
                        ...
                        {visit.isHost && 
                            <Item.Description>
                            <Label basic color='orange' content='You created this visit' />
                            </Item.Description>
                        }
            ...
            <Segment clearing>
                ...
                <Button as={Link} to={`/visits/${visit.id}`}floated='right' content='View' color='blue' />   
            </Segment>
